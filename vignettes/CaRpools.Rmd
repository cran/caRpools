---
title: "The caRpools package - Analysis of pooled CRISPR Screens"
output: html_vignette
vignette: >
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteIndexEntry{The caRpools package - Analysis of pooled CRISPR Screens}
  \usepackage[utf8]{inputenc}
---

![](./pictures/CaRpools.png)

```{r htmlvignette, echo=FALSE}
...
"dataset" is used to generate in-depth statistics for each gene of a dataset,
...
```{r read-distribution, echo=TRUE,fig.height=4, fig.width=8, eval=TRUE}
# Histogram
carpools.read.distribution(CONTROL1, fullmatchcolumn=2,breaks=200,
  title=d.CONTROL1, xlab="log2 Readcount", ylab="# sgRNAs",statistics=TRUE) 
```

```{r read-distribution-whisker, echo=TRUE,fig.height=4, fig.width=8, eval=TRUE}
# Whisker
carpools.read.distribution(CONTROL1, fullmatchcolumn=2,breaks=200,
  title=d.CONTROL1, xlab="log2 Readcount", ylab="# sgRNAs",statistics=TRUE,
  type="whisker") 
...
```{r read-distribution-onlygene, echo=TRUE, fig.height=4, fig.width=8, eval=TRUE}
# Histogram
carpools.read.distribution(CONTROL1, fullmatchcolumn=2,breaks=200,
...
```{r read-depth-example1, echo=TRUE, eval=TRUE,fig.height=4, fig.width=8}
# Plot for a singe sample
carpools.read.depth(datasets = list(CONTROL1), namecolumn=1 ,fullmatchcolumn=2,
  dataset.names=list(d.CONTROL1), extractpattern=expression("^(.+?)_.+"),
  xlab="Genes", ylab="Read Count per sgRNA",statistics=TRUE, labelgenes = NULL,
...
```{r read-depth-example2, echo=TRUE, eval=TRUE,fig.height=4, fig.width=8}
...
```{r readcount-vs1, echo=TRUE, eval=TRUE, fig.width=7, fig.height=7}
...
```{r readcount-vs12, echo=TRUE, eval=TRUE, fig.width=7, fig.height=7}
...
```{r readcount-vs13, echo=TRUE, eval=TRUE, fig.width=7, fig.height=7}
...
```{r readcount-vs2, echo=TRUE, eval=TRUE, fig.width=8, fig.height=8}
# Highlight non-targeting control in all datasets
carpools.read.count.vs(dataset=list(TREAT1, TREAT2, CONTROL1, CONTROL2),
  dataset.names = c(d.TREAT1, d.TREAT2, d.CONTROL1, d.CONTROL2), pairs=TRUE, namecolumn=1,
  fullmatchcolumn=2, title="", pch=16, normalize=TRUE, norm.function=median,
...
```{r readcount-vs22, echo=TRUE, eval=TRUE, fig.width=8, fig.height=8}
...
```{r plot.raw.genes-example1, echo=TRUE, eval=TRUE , fig.width=8, fig.height=4}
# Foldchange
...
```{r p-val-visualization, echo=TRUE, eval=TRUE, fig.width=7, fig.height=7}
...
```{r HT-visualization-mageck-example1, echo=TRUE, eval=TRUE, sanitize=TRUE, fig.width=10, fig.height=6}
...
```{r HT-visualization-wilcox-example1, echo=TRUE, eval=TRUE, sanitize=TRUE, fig.width=10, fig.height=6}
...
```{r HT-overview-hits, echo=TRUE, eval=TRUE, sanitize=TRUE, fig.width=7, fig.height=7}
...
```{r HT-compare-enriched-overlap, echo=TRUE, sanitize=TRUE, fig.width=7, fig.height=7}
...
```{r HT-comparetable-enriched-ranked, echo=TRUE, sanitize=TRUE, fig.width=7, fig.height=7}
# Perform the comparison
data.analysis.enriched = compare.analysis(wilcox=data.wilcox,
    deseq=data.deseq, mageck=data.mageck, type="enriched",
...
```{r HT-comparetable-enriched-3d, echo=TRUE, sanitize=TRUE, fig.width=7, fig.height=7}
...
```{r hit-scatter, echo=TRUE, eval=TRUE, fig.height=8, fig.width=8}
...
```{r carpools.hit.sgrna, echo=TRUE, eval=TRUE, fig.width=8, fig.height=6}
